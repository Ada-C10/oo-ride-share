  ...
  describe "trips property" do
    ...
    it "return total cost for trips per user" do
      ...
      @user = RideShare::User.new(id: 8, name: "Merl Glover III",
        ...
        trip = RideShare::Trip.new(id: 8, driver: nil, passenger: @user, start_time: Time.parse("2016-08-08"),end_time: Time.parse("2016-08-09"),cost: 15, rating: 5)
      ...
      it "return total time spent on all trips per user" do
        ...
        @user = RideShare::User.new(id: 8, name: "Merl Glover III", phone: "1-602-620-2330 x3723", trips: [])

        start_time = Time.parse('2015-05-20T12:14:00+00:00')
        end_time = start_time + 25

        trip = RideShare::Trip.new(id: 8, driver: nil, passenger: @user, start_time: start_time, end_time: end_time, cost: 15, rating: 5)
